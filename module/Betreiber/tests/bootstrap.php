...
$sharedEvents = new Zend\BetreiberManager\SharedBetreiberManager();
$moduleManager = new \Zend\ModuleManager\ModuleManager($modules);
$moduleManager->getBetreiberManager()->setSharedManager($sharedBetreibern);
$moduleManager->getBetreiberManager()->attachAggregate($defaultListeners);
...
unset($moduleManager, $sharedBetreibern);
