...
$sharedEvents = new Zend\AdminManager\SharedAdminManager();
$moduleManager = new \Zend\ModuleManager\ModuleManager($modules);
$moduleManager->getAdminManager()->setSharedManager($sharedAdmins);
$moduleManager->getAdminManager()->attachAggregate($defaultListeners);
...
unset($moduleManager, $sharedAdmins);
